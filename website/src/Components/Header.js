    ...
    return (
        <HeaderContainer>
            ...
            <HeaderSubContainer style={{backgroundColor: "#e31837"}}>
                <Header2XSubContainer>
                    <FlexCenter>
                        <FirstRedText>Star Professors: Student-Made for YorkU</FirstRedText>
            ...
            <HeaderSubContainer style={{backgroundColor: "#8C0000", height: "45px"}}>
                <Header2XSubContainer>
                    <FlexCenter>
                        <ButtonContainer>
                            <Button target="_blank" href="https://github.com/isaackogan/YorkUProfRatings">GitHub Project</Button>
